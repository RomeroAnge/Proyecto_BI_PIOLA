...
def construir_dim_tiempo(fichas):
    fechas = pd.to_datetime(fichas["fechaHoraReserva"], errors="coerce").dt.normalize()
...
def validar_claves_modelo(fact_atenciones):
    columnas_fact = [
...
if __name__ == "__main__":
    ...
    crear_base_gold()
    fichas, cepal = cargar_silver()

    dim_tiempo = construir_dim_tiempo(fichas)
    ...
    validar_claves_modelo(fact_atenciones)
